...
description: "Explore the Wazuh Docker Stack's four-component architecture, inter-service communication, network topology, certificate layout, and Docker volume structure."
---
...
All named volumes in the stack use Docker's default local driver and persist automatically across container restarts and upgrades:
