---
title: "Configure the Wazuh Manager: ossec.conf Reference"
sidebarTitle: "Manager"
description: "Reference guide for config/wazuh_cluster/wazuh_manager.conf covering global settings, FIM, SCA, vulnerability detection, active response, and cluster configuration."
---
