---
title: "Deploy a Wazuh Agent to Monitor Remote Hosts"
sidebarTitle: "Agent"
description: "Connect a Wazuh 4.14.1 agent to the Manager — run it as a Docker container on a remote host or install it natively on Linux with Docker monitoring enabled."
---
