---
title: "Deploy the Wazuh 4.14.5 Server Stack via Docker Compose"
sidebarTitle: "Server Stack"
description: "Deploy Wazuh Indexer, Manager, and Dashboard using docker-compose.yml or the wazuh-dev.sh script, with pre-deployment checks and resource guidance."
---
