---
title: "Security Hardening for the Wazuh Docker Stack"
...
- The `.env.example` file is safe to commit as a template (it contains only illustrative placeholder values).
...
<global>
  ...
  <white_list>^admin-jumphost.simovilab.local$</white_list>
</global>
```
